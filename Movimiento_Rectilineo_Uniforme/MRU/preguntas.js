...
function verificarRespuesta1() {
    ...
    else if (respuesta === "240 km ") {
        resultadoDiv.textContent = "¡Correcto!";
        resultadoDiv.style.color = "green";
    } 
    else if (respuesta === "240km") {
        resultadoDiv.textContent = "¡Correcto!";
        resultadoDiv.style.color = "green";
    } 
    else if (respuesta === "240km ") {
...
function verificarRespuesta2() {
    ...
    if (respuesta2 === "5 s") {
    ...
    else if (respuesta2 === "5 s ") {
        resultadoDiv2.textContent = "¡Correcto!";
        resultadoDiv2.style.color = "green";
    }
    else if (respuesta2 === "5s") {
        resultadoDiv2.textContent = "¡Correcto!";
        resultadoDiv2.style.color = "green";
    } 
    else if (respuesta2 === "5s ") {
        ...
        resultadoDiv2.textContent = "¡Correcto! pero  Recuerda que su unidad de medida es s";
        resultadoDiv2.style.color = "green";
    }
    else if (respuesta2 === "5 ") {
        resultadoDiv2.textContent = "¡Correcto! pero  Recuerda que su unidad de medida es s";
...
function verificarRespuesta3() {
    ...
    if (respuesta3 === "2 h") {
    ...
    else if (respuesta3 === "2 h ") {

        resultadoDiv3.textContent = "¡Correcto!";
        resultadoDiv3.style.color = "green";
    }
    else if (respuesta3 === "2h") {
        resultadoDiv3.textContent = "¡Correcto!";
        resultadoDiv3.style.color = "green";
    }
    else if (respuesta3 === "2h ") {
        ...
        resultadoDiv3.textContent = "¡Correcto! pero Recuerda que su unidad de medida es h";
        resultadoDiv3.style.color = "green";
    }
    else if (respuesta3 === "2 ") {
        resultadoDiv3.textContent = "¡Correcto! pero Recuerda que su unidad de medida es h";
...
function verificarRespuesta4() {
    ...
    else if (respuesta4 === "40 m ") {
        resultadoDiv4.textContent = "¡Correcto!";
        resultadoDiv4.style.color = "green";
    } 
    else if (respuesta4 === "40m") {
        resultadoDiv4.textContent = "¡Correcto!";
        resultadoDiv4.style.color = "green";
    }
    else if (respuesta4 === "40m ") {
    ...
    else if (respuesta4 === "40") {
        resultadoDiv4.textContent = "¡Correcto! pero Recuerda que su unidad de medida es m";
        resultadoDiv4.style.color = "green";
    }
    else if (respuesta4 === "40 ") {
        resultadoDiv4.textContent = "¡Correcto! pero Recuerda que su unidad de medida es m";
...
function verificarRespuesta5() {
    ...
    if (respuesta5 === "100 km") {
        resultadoDiv5.textContent = "¡Correcto!";
        resultadoDiv5.style.color = "green";
    }
    else if (respuesta5 === "100 km ") {
        resultadoDiv5.textContent = "¡Correcto!";
        resultadoDiv5.style.color = "green";
    }
    else if (respuesta5 === "100km") {
        resultadoDiv5.textContent = "¡Correcto!";
        resultadoDiv5.style.color = "green";
    }
    else if (respuesta5 === "100km ") {
    ...
    else if (respuesta5 === "100") {
        resultadoDiv5.textContent = "¡Correcto! pero Recuerda que su unidad de medida es km";
        resultadoDiv5.style.color = "green";
    }
    else if (respuesta5 === "100 ") {
        resultadoDiv5.textContent = "¡Correcto! pero Recuerda que su unidad de medida es km";
...
function verificarRespuesta6() {
    ...
    else if (respuesta6 === "25 s ") {
        resultadoDiv6.textContent = "¡Correcto!";
        resultadoDiv6.style.color = "green";
    }
    else if (respuesta6 === "25") {
        resultadoDiv6.textContent = "¡Correcto! pero Recuerda que su unidad de medida es s";
        resultadoDiv6.style.color = "green";
    }
    else if (respuesta6 === "25 ") {
        resultadoDiv6.textContent = "¡Correcto! pero Recuerda que su unidad de medida es s";
...
function verificarRespuesta7() {
    ...
    if (respuesta7 === "150 km") {
        resultadoDiv7.textContent = "¡Correcto!";
        resultadoDiv7.style.color = "green";
    } 
    else if (respuesta7 === "150 km ") {
        resultadoDiv7.textContent = "¡Correcto!";
        resultadoDiv7.style.color = "green";
    } 
    else if (respuesta7 === "150km") {
        resultadoDiv7.textContent = "¡Correcto!";
        resultadoDiv7.style.color = "green";
    }
    else if (respuesta7 === "150km ") {
    ...
    else if (respuesta7 === "150") {
        resultadoDiv7.textContent = "¡Correcto! pero pero Recuerda que su unidad de medida es km";
        resultadoDiv7.style.color = "green";
    }
    else if (respuesta7 === "150 ") {
        resultadoDiv7.textContent = "¡Correcto! pero pero Recuerda que su unidad de medida es km";
...
function verificarRespuesta8() {
    ...
    else if (respuesta8 === "5 m/s ") {
        resultadoDiv8.textContent = "¡Correcto!";
        resultadoDiv8.style.color = "green";
    }
    else if (respuesta8 === "5") {
        resultadoDiv8.textContent = "¡Correcto! pero pero Recuerda que su unidad de medida es m/s";
        resultadoDiv8.style.color = "green";
    }
    else if (respuesta8 === "5 ") {
        resultadoDiv8.textContent = "¡Correcto! pero pero Recuerda que su unidad de medida es m/s";
...
function verificarRespuesta9() {
    ...
    else if (respuesta9 === "2.5 h ") {
        resultadoDiv9.textContent = "¡Correcto!";
        resultadoDiv9.style.color = "green";
    }
    else if (respuesta9 === "2") {
        resultadoDiv9.textContent = "¡Correcto! pero Recuerda que su unidad de medida es h";
        resultadoDiv9.style.color = "green";
    }
    else if (respuesta9 === "2 ") {
        resultadoDiv9.textContent = "¡Correcto! pero Recuerda que su unidad de medida es h";
...
function verificarRespuesta10() {
    ...
    if (respuesta10 === "900 km") {
        resultadoDiv10.textContent = "¡Correcto!";
        resultadoDiv10.style.color = "green";
    } 
    else if (respuesta10 === "500 km ") {
        resultadoDiv10.textContent = "¡Correcto!";
        resultadoDiv10.style.color = "green";
    } 
    else if (respuesta10 === "900km") {
        resultadoDiv10.textContent = "¡Correcto!";
        resultadoDiv10.style.color = "green";
    }
    else if (respuesta10 === "900km " ) {
    ...
    else if (respuesta10 === "900") {
        resultadoDiv10.textContent = "¡Correcto! pero Recuerda que su unidad de medida se km";
        resultadoDiv10.style.color = "green";
    }
    else {
